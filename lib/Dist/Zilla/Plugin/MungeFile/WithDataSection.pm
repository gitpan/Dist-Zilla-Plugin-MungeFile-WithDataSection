...
BEGIN {
  $Dist::Zilla::Plugin::MungeFile::WithDataSection::AUTHORITY = 'cpan:ETHER';
}
# git description: v0.006-10-g21aae60
$Dist::Zilla::Plugin::MungeFile::WithDataSection::VERSION = '0.007';
...
=for :stopwords Karen Etheridge FileMunger FileFinder syntactual irc
